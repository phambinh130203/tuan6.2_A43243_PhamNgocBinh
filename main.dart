    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          ...
          child: Text("Go to ProductLissScreen"),
        ),
      ),
    );
  }
...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  Future<void> fetchProduct() async {
    final response = await http.get(
        Uri.parse("http://10.0.0.119/aserver/api.php"));
    if (response.statusCode == 200) {
      ...
      throw Exception("khong load duoc");
    }
  }
          ...
          return ListTile(
            ...
            subtitle: Column(crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Text('product_additional_info: ${products[index]
            ...
            onTap: (){
              Navigator.push(context, 
              MaterialPageRoute(builder: (context)=>ProductDatailScreen(products[index]),
...
class ProductDatailScreen extends StatelessWidget {
  ...
  ProductDatailScreen(this.product);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Product Deatail'),
        actions: [
 ...
 class CartScreen extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
   return Scaffold(
     ...
     body: Center(child: Text('Gio hang'),) ,
   );
  }
...
class Product {
  ...
  Product({required this.search_image,required this.styleid,required this.brands_filter_facet,required this.price,
